...
import { PathComp } from "../models/pathcomp";
...
function matches(country: Country, term: string, pipe: PipeTransform) {
  return (
    country.computerName.toLowerCase().includes(term.toLowerCase()) ||
...
export class CountryService {
  ...
  //get patch complaince
  pathcomps$() {
    return this.http
      .get(`${"http://168.61.44.82:8080/api/v1/min_fixlets/0/25/0/0"}`)
